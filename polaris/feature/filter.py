...
def preprocess_data(dataframe):
    ...
    :rtype: pd.DataFrame
    """
    col_threshold = 30  # in percent, maximum na rows in a column
    row_threshold = 60  # in percent, maximum na columns in a row
