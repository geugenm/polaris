...
class Lightsail2(Normalizer):
    def __init__(self):
        self.normalizers = [
            ...
            Field('daughter_atmp', lambda x: x * 0.5 - 75, 'degC', 'Daughter Board A Temperature'),
            Field('daughter_btmp', lambda x: x * 0.5 - 75, 'degC', 'Daughter Board B Temperature'),
            Field('rf_amptmp', lambda x: x * 0.5 - 75, 'degC', 'RF Amplifier Temperature'),
            Field('threev_pltmp', lambda x: x * 0.5 - 75, 'degC', '3V3 Payload Temperature'),
            Field('atmelpwrcurr', lambda x: x / 2048, 'A', 'CPU Power Current'),
            Field('atmelpwrbusv', lambda x: x / 32, 'V', 'CPU Power Voltage'),
            Field('threev_pwrcurr', lambda x: x / 2048, 'A', '3V3 Power Current'),
            Field('threev_pwrbusv', lambda x: x / 32, 'V', '3V3 Power Voltage'),
            Field('threev_plpwrcurr', lambda x: x / 128, 'A', '3V3 Payload Current'),
            Field('threev_plpwrbusv', lambda x: x / 32, 'V', '3V3 Payload Voltage'),
            Field('fivev_plpwrcurr', lambda x: x / 128, 'A', '5V Payload Current'),
            Field('fivev_plpwrbusv', lambda x: x / 32, 'V', '5V Payload Voltage'),
            Field('daughter_apwrcurr', lambda x: x / 128, 'A', 'Daughter Board A Power Current'),
            Field('daughter_apwrbusv', lambda x: x / 32, 'V', 'Daughter Board A Power Voltage'),
            Field('daughter_bpwrcurr', lambda x: x / 128, 'A', 'Daughter Board A Power Current'),
            Field('daughter_bpwrbusv', lambda x: x / 32, 'V', 'Daughter Board B Power Voltage'),
            Field('nx_tmp', lambda x: x * 0.5 - 75, 'degC', '-X Temperature'),
            Field('nx_intpwrcurr', lambda x: x / 64, 'A', '-X Int Power Current'),
            Field('nx_intpwrbusv', lambda x: x / 32, 'V', '-X Int Power Voltage'),
            Field('nx_extpwrcurr', lambda x: x / 64, 'A', '-X Ext Power Current'),
            Field('nx_extpwrbusv', lambda x: x / 32, 'V', '-X Ext Power Voltage'),
            Field('px_tmp', lambda x: x * 0.5 - 75, 'degC', '+X Temperature'),
            Field('px_intpwrcurr', lambda x: x / 64, 'A', '+X Int Power Current'),
            Field('px_intpwrbusv', lambda x: x / 32, 'V', '+X Int Power Voltage'),
            Field('px_extpwrcurr', lambda x: x / 64, 'A', '+X Ext Power Current'),
            Field('px_extpwrbusv', lambda x: x / 32, 'V', '+X Ext Power Voltage'),
            Field('ny_tmp', lambda x: x * 0.5 - 75, 'degC', '-Y Temperature'),
            Field('ny_intpwrcurr', lambda x: x / 64, 'A', '-Y Int Power Current'),
            Field('ny_intpwrbusv', lambda x: x / 32, 'V', '-Y Int Power Voltage'),
            Field('ny_extpwrcurr', lambda x: x / 64, 'A', '-Y Ext Power Current'),
            Field('ny_extpwrbusv', lambda x: x / 32, 'V', '-Y Ext Power Voltage'),
            Field('py_tmp', lambda x: x * 0.5 - 75, 'degC', '+Y Temperature'),
            Field('py_intpwrcurr', lambda x: x / 64, 'A', '+Y Int Power Current'),
            Field('py_intpwrbusv', lambda x: x / 32, 'V', '+Y Int Power Voltage'),
            Field('py_extpwrcurr', lambda x: x / 64, 'A', '+Y Ext Power Current'),
            Field('py_extpwrbusv', lambda x: x / 32, 'V', '+Y Ext Power Voltage'),
            Field('nz_tmp', lambda x: x * 0.5 - 75, 'degC', '-Z Temperature'),
            Field('nz_extpwrcurr', lambda x: x / 64, 'A', '-Z Ext Power Current'),
            Field('nz_extpwrbusv', lambda x: x / 32, 'V', '-Z Ext Power Voltage'),
            ...
            Field('long_dur_counter', lambda x: x, None, 'Long Duration Counter'),
            ...
            Field('cam0_temp', lambda x: x * 0.5 - 75, None, 'Camera 0 Temperature'),
            Field('cam0_last_contact', lambda x: x, None, 'Camera 0 Seconds Since Last Contact'),
            Field('cam0_pics_remaining', lambda x: x, None, 'Camera 0 Pics Remaining'),
            Field('cam0_retry_fails', lambda x: x, None, 'Camera 0 Retry Fails'),
            Field('cam1_status', lambda x: x, None, 'Camera 1 Status Bits'),
            Field('cam1_temp', lambda x: x * 0.5 - 75, 'degC', 'Camera 1 Temperature'),
            Field('cam1_last_contact', lambda x: x, 's', 'Camera 1 Seconds Since Last Contact'),
            Field('cam1_pics_remaining', lambda x: x, None, 'Camera 1 Pics Remaining'),
            Field('cam1_retry_fails', lambda x: x, None, 'Camera 1 Retry Fails'),
            Field('torqx_pwrcurr', lambda x: x / 128, 'A', 'X Torquer Current'),
            Field('torqx_pwrbusv', lambda x: x / 16, 'V', 'X Torquer Voltage'),
            Field('torqy_pwrcurr', lambda x: x / 128, 'A', 'Y Torquer Current'),
            Field('torqy_pwrbusv', lambda x: x / 16, 'V', 'Y Torquer Voltage'),
            Field('torqz_pwrcurr', lambda x: x / 128, 'A', 'Z Torquer Current'),
